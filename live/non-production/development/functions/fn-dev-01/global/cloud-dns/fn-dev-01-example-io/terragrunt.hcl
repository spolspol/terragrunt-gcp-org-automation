# Private DNS zone for fn-dev-01
...
dependency "postgres" {
  config_path = "../../europe-west2/cloud-sql/postgres-main"
  mock_outputs = {
    private_ip_address = "10.20.200.5"
  }
  mock_outputs_allowed_terraform_commands = ["validate", "plan", "init"]
  skip_outputs                            = false
}
  ...
  recordsets = [
    {
      ...
      records = [try(dependency.postgres.outputs.private_ip_address, "10.20.200.5")]
    },
  ]
