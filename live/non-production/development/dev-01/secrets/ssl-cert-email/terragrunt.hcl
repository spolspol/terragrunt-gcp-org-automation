# SSL Certificate Email Secret
# Email address used for Let's Encrypt SSL certificate registration
...
inputs = {
  ...
  secrets = [
    {
      name        = "ssl-cert-email"
      secret_data = "admin@example.com"  # Replace with actual email in production
    }
  ]
